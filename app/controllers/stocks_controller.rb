class StocksController < ApplicationController
    ...
    def show
        user = User.find_by(id: params[:id])
        unique_stock_transactions = user.transactions.where(symbol: params[:symbol])
        ...
        unique_stock = {symbol: params[:symbol], total_shares: total_shares, total_price: total_price}

        render json: unique_stock
    end
